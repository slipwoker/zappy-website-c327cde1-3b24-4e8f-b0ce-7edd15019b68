  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      // Tel check
        ...
        errorMessage = ERROR_MESSAGES.tel;
      }
      // Minlength check
      else if (field.hasAttribute('minlength') && value.trim() !== '') {
        const minLen = field.getAttribute('minlength');
        if (!VALIDATORS.minlength(value, minLen)) {
          errorMessage = typeof ERROR_MESSAGES.minlength === 'function'
            ? ERROR_MESSAGES.minlength(minLen)
      ...
      if (errorMessage) {
        ...
        if (value.trim() !== '') field.classList.add('field-valid');
    ...
    // Live validation on blur using event delegation
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c327cde1-3b24-4e8f-b0ce-7edd15019b68',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c327cde1-3b24-4e8f-b0ce-7edd15019b68';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c327cde1-3b24-4e8f-b0ce-7edd15019b68';
